...
import 'modulos/usuario/passagem_aerea/apresentacao/views/comprar_passagem_aerea/comprar_passagem_aerea_view.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          UsuarioRoutes.comprarPassagem: (ctx) =>
              const ComprarPassagemAereaView(),
